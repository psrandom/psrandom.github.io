...
svm.price.model = train(Case ~ Case1, data=data.train, method="svmLinear",   
 preProc=c("range"),trControl=trainControl)# Predict Close Price on test data  
